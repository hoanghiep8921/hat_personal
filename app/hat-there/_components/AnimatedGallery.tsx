...
function ImageGallery({ images, altPrefix }: ImageCarouselProps) {
  ...
  return (
    <div className="relative overflow-hidden">
      ...
      <button
        onClick={handlePrev}
        className="absolute left-4 top-1/2 transform -translate-y-1/2 /50 p-2 rounded-full hover:/70 transition-colors"
      ...
      <button
        onClick={handleNext}
        className="absolute right-4 top-1/2 transform -translate-y-1/2 /50 p-2 rounded-full hover:/70 transition-colors"
